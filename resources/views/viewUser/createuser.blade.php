								...
								<form role="form"  action="{{ url('/view-users') }}" method="POST">
									...
									<div class="col-lg-12 center-block">
										...
										<div class="form-group">
											...
											<input class="form-control" name="fname" placeholder="eg: Bubelwa">
										</div>

										<div class="form-group">
											<label>Middle Name (Optional): </label>
											<input class="form-control" name="mname" placeholder="eg: Kulindwa">
										</div>

										<div class="form-group">
											<label>Last Name:</label>
											<input class="form-control" name="lname" placeholder="eg: Juma">
										</div>

										<div class="form-group">
											<label>Phone Number:</label>
											<input type="tel" class="form-control" name="pnumber" placeholder="eg: +255713567890">
										</div>
