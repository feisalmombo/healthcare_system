...
<head>
    ...
    <title>{{config('app.name', 'Delis Healthcare') }} | @yield('title')</title>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />
    ...
    <!-- DataTables CSS -->
    <!-- {{--  <link href="{{asset('temp/vendor/datatables-plugins/dataTables.bootstrap.css')}}" rel="stylesheet">--}} -->
    <link href="{{asset('css/jquery.dataTables.min.css')}}" rel="stylesheet">


    <!-- DataTables Responsive CSS -->
   <!-- {{--  <link href="{{asset('temp/vendor/datatables-responsive/dataTables.responsive.css')}}" rel="stylesheet">--}} -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <div clas="row">
                    <div class="col-1">  
                        <a class="navbar-brand" href="{{ url('/home') }}">Delis Healthcare</a>  
                    </div>  
                </div>
            </div>